...
class Client(object):
    ...
    def __init__(self):
        self.serverHost = input("Enter server IP: ")
        self.serverPort = int(input("Enter port: "))
        self.socket = None
    ...
    def socket_connect(self):
        ...
        try:
            ...
            print("Socket connected to " + self.serverHost)
        except socket.error as e:
    ...
    def receive_commands(self):
        ...
        try:
            self.socket.recv(10)
            print("Waiting for commands from the server")
        except Exception as e:
